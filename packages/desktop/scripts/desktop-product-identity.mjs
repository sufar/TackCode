...
const PRODUCTION_IDENTITY = Object.freeze({
  flavor: "production",
  // TackCode rebrand: neutral identity, no Zhipu trademarks.
  appId: "dev.tackcode.app",
  productName: "TackCode",
  linuxExecutableName: "TackCode",
  linuxPackageName: "TackCode",
  cuaHelperInstallVariant: null,
});

const PREVIEW_IDENTITY = Object.freeze({
  flavor: "preview",
  appId: "dev.tackcode.app.preview",
  productName: "TackCode Preview",
  linuxExecutableName: "TackCode-preview",
  linuxPackageName: "TackCode-preview",
